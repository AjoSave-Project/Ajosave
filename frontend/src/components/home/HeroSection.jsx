    ...
    >
      <div className="max-w-6xl mx-auto px-4 relative z-10 w-full">
        <div className="grid lg:grid-cols-12 gap-8 items-end">
          <div className="lg:col-span-12 space-y-4 text-right flex flex-col items-end">

            {/* Eyebrow */}
            <div className="overflow-hidden pl-4 pr-0 w-full flex justify-end">
            ...
            <div className="overflow-hidden pl-4 pr-0 w-full flex justify-end">
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2 justify-end animate-slideFromRight [animation-delay:200ms]">
                <button
                  onClick={onJoinBeta}
                  className="bg-white text-deepBlue-800 px-6 py-3 rounded-lg font-medium hover:bg-gray-100 transition-all flex items-center justify-end gap-2 text-sm shadow-lg backdrop-blur-sm"
                >
                  Start Saving for Free <ArrowRight className="w-4 h-4" />
                </button>
                <button
                  onClick={onHowItWorks}
                  className="flex items-center justify-end gap-2 text-white hover:text-blue-300 font-medium px-5 py-3 text-sm transition-colors rounded-lg hover:bg-white/10 backdrop-blur-sm border border-white/20"
                >
            ...
            <div className="overflow-hidden pl-4 pr-0 w-full flex justify-end">
              <div className="pt-4 flex flex-col sm:flex-row items-center gap-4 justify-end animate-slideFromRight [animation-delay:300ms]">
