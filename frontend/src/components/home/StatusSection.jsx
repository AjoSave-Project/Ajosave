...
const StatusSection = ({ sectionRef }) => {
  return (
    <div
      ref={sectionRef}
      className="relative bg-primary-500 pt-32 pb-36 overflow-hidden -mt-[4vw]"
      style={{
    ...
    >
      <div className="relative z-10 max-w-6xl mx-auto px-4">
        <div className="max-w-2xl mb-14">
          <h2 className="text-xs font-bold uppercase tracking-widest text-blue-300 mb-2">Why digital is better</h2>
          <p className="text-4xl font-bold tracking-tight text-white">
            Managing contributions manually leaves too much room for error.
          </p>
          <p className="text-blue-200 mt-4 text-base leading-relaxed max-w-xl">
